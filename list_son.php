...
<div id="position" class="auto">
	 <a href="index.php">首页</a> &gt; <a href="list_father.php?id=<?php echo $data_father['Id']?>"><?php echo $data_father['module_name']?></a> &gt; <a href="list_son.php?id=<?php echo $data_son['Id']?>"><?php echo $data_son['module_name']?></a>
</div>
<div id="main" class="auto">
	<div id="left">
		...
		<ul class="postsList">
			<?php 
			$query="select
			content.title,content.Id,content.time,content.times,content.member_id,member.username,member.photo
			...
			<li>
				...
				<div class="subject">
					...
					<p>
						楼主：<?php echo $data_content['username']?>&nbsp;<?php echo $data_content['time']?>&nbsp;&nbsp;&nbsp;&nbsp;最后回复：<?php echo $last_time?><br />
						<?php
