...
<div id="main" class="auto">
	<div id="left">
		...
		<ul class="postsList">
			<?php 
			$query="select 
			content.title,content.Id,content.time,content.times,content.member_id,member.username,member.photo,son_module.module_name,son_module.Id sm_id 
			...
			<ul class="listWrap">
				...
				<li>
					...
					<ul>
						...
						$result_son=execute($link,$query);
						while($data_father=mysqli_fetch_assoc($result_son)){
						?>
